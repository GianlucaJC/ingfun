$(document).ready( function () {
    $('#tbl_ordine tfoot th').each(function () {
        var title = $(this).text();
		if (title.length!=0)
			$(this).html('<input type="text" placeholder="Search ' + title + '" />');
    });	
    var table=$('#tbl_ordine').DataTable({
		dom: 'Bfrtip',
		buttons: [
			'excel', 'pdf'
		],		
        ...
        language: {
            ...
            infoEmpty: 'Non sono presenti ordini a fornitori',
            infoFiltered: '(Filtrati da _MAX_ ordini totali)',
        },
