$(document).ready( function () {
    $('#tbl_fornitori tfoot th').each(function () {
        var title = $(this).text();
		if (title.length!=0)
			$(this).html('<input type="text" placeholder="Search ' + title + '" />');
    });	
    var table=$('#tbl_fornitori').DataTable({
		dom: 'Bfrtip',
		buttons: [
			'excel', 'pdf'
		],		
        ...
        language: {
            ...
            infoEmpty: 'Non sono presenti fornitori',
            infoFiltered: '(Filtrati da _MAX_ fornitori totali)',
        },
