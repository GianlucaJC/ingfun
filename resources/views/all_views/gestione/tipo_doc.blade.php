...
@section('content_main')
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">TIPOLOGIE DI DOCUMENTO</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Tipologie di documento</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <div class="content">
      <div class="container-fluid">
		...
		@include('all_views.gestione.newtipodoc')
		

		<form method='post' action="{{ route('tipo_documento') }}" id='frm_tipodoc_contr' name='frm_tipodoc_contr' autocomplete="off">
        ...
        <div class="row">
          <div class="col-md-12">
				...
				<table id='tbl_list_tipodoc' class="display">
					<thead>
						<tr>
							<th>ID</th>
							<th>Descrizione</th>
 ...
 @section('content_plugin')
	...
	<script src="{{ URL::asset('/') }}dist/js/tipo_doc.js?ver=1.3"></script>
