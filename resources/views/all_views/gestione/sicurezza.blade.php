...
@section('content_main')
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">FORM ATTESTATI DI SICUREZZA</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
			  <li class="breadcrumb-item">Archivi</li>
              <li class="breadcrumb-item active">frm-attestati</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <div class="content">
      <div class="container-fluid">
		...
		@include('all_views.gestione.newattestato')

		<form method='post' action="{{ route('frm_attestati') }}" id='frm_attestati' name='frm_attestati' autocomplete="off">
        ...
        <div class="row">
          <div class="col-md-12">
				...
				<table id='tbl_list_attestati' class="display">
					<thead>
						<tr>
							<th>ID</th>
							<th>Descrizione</th>
							...
							<tr>
								...
								<td>
								 @if ($sic->dele=="1") 
									<font color='red'><del> 
								 @endif
									<span id='id_descr{{$sic->id}}' data-descr='{{ $sic->descrizione }}'>
										{{ $sic->descrizione }}
									</span>	
								 @if ($sic->dele=="1") 
									 </del></font>
			...
			<div class="row">
			    <div class="col-lg-12">
					<button type="button" class="btn btn-primary" onclick="$('#edit_elem').val('');$('#descr_contr').val('');$('#div_definition').show(150)">
						<i class="fa fa-plus-circle"></i> Nuova Voce
					</button>
					<div class="form-check form-switch mt-3 ml-3">
					  <input class="form-check-input" type="checkbox" id="view_dele" name="view_dele" onchange="$('#frm_attestati').submit()" {{ $check }}>
 ...
 @section('content_plugin')
	...
	<script src="{{ URL::asset('/') }}dist/js/frm_attestati.js?ver=1.47"></script>
