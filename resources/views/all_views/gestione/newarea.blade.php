<div id='div_definition' style='display:none'>
	<form method='post' action="{{ route('area_impiego') }}" id='frm_area1' name='frm_area1' autocomplete="off">	
		...
		<div class="container-fluid">
			<hr>
			<h4>
				<font color='red'>Definizione Area di Impiego</font>
			</h4>
				<div class="row">
					<div class="col-md-6">
					...
					<div class="col-md-6">
						<button type="submit" class="btn btn-success" >Crea/Modifica Area Impiego</button>
