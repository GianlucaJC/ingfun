...
@section('content_main')
  ...
  <div class="content-wrapper">
    ...
    <div class="content">
      <div class="container-fluid">
		...
		@include('all_views.gestione.newmansione')

		<form method='post' action="{{ route('mansione') }}" id='frm_mansione' name='frm_mansione' autocomplete="off">
        ...
        <div class="row">
          <div class="col-md-12">
				...
				<table id='tbl_list_mansione' class="display">
					<thead>
						<tr>
							<th>ID</th>
							<th>Descrizione</th>
							...
							<tr>
								...
								<td>
								 @if ($mans->dele=="1") 
									<font color='red'><del> 
								 @endif
									<span id='id_descr{{$mans->id}}' data-descr='{{ $mans->descrizione }}'>
										{{ $mans->descrizione }}
									</span>	
								 @if ($mans->dele=="1") 
									 </del></font>
			...
			<div class="row">
			    <div class="col-lg-12">
					<button type="button" class="btn btn-primary" onclick="$('#edit_elem').val('');$('#descr_contr').val('');$('#div_definition').show(150)">
						<i class="fa fa-plus-circle"></i> Nuova Mansione
					</button>
					<div class="form-check form-switch mt-3 ml-3">
					  <input class="form-check-input" type="checkbox" id="view_dele" name="view_dele" onchange="$('#frm_mansione').submit()" {{ $check }}>
					  <label class="form-check-label" for="view_dele">Mostra anche Mansioni eliminate</label>
					</div>
				</div>
			</div>	
		</form>
 ...
 @section('content_plugin')
	...
	<script src="{{ URL::asset('/') }}dist/js/mansione.js?ver=1.2"></script>
