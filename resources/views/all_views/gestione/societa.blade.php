  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">SOCIETA' DI ASSUNZIONE</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Società di assunzione</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <div class="content">
      <div class="container-fluid">
		...
		@include('all_views.gestione.newsocieta')

		<form method='post' action="{{ route('societa_assunzione') }}" id='frm_soc' name='frm_soc' autocomplete="off">
        ...
        <div class="row">
          <div class="col-md-12">
				...
				<table id='tbl_list_societa' class="display">
					<thead>
						<tr>
							<th>ID</th>
			...
			<div class="row">
			    <div class="col-lg-12">
					<button type="button" class="btn btn-primary" onclick="$('#edit_elem').val('');$('#descr_contr').val('');$('#div_definition').show(150)">
						<i class="fa fa-plus-circle"></i> Nuova Società
					</button>
					<div class="form-check form-switch mt-3 ml-3">
					  <input class="form-check-input" type="checkbox" id="view_dele" name="view_dele" onchange="$('#frm_soc').submit()" {{ $check }}>
					  <label class="form-check-label" for="view_dele">Mostra anche società eliminate</label>
					</div>
				</div>
			</div>	
		</form>
