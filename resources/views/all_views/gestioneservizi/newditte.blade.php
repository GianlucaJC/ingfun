	...
	<form method='post' action="{{ route('ditte') }}" id='frm_ditte1' name='frm_ditte1' autocomplete="off">	
		...
		<div class="container-fluid">
			...
			<div class="row mb-3">
				<div class="col-md-12">
					<div class="form-check">
					  <input class="form-check-input" type="radio" name="pf_pi" id="r2" value=0>
					  <label class="form-check-label" for="r2">
						Partita IVA
					  </label>
					</div>
					<div class="form-check">
					  <input class="form-check-input" type="radio" name="pf_pi" id="r1" value=1 checked>
			...
			<div class="row mb-3">
				<div class="col-md-6">
					<div class="input-group mb-3">
					  ...
					  <input type="text" class="form-control" placeholder="Cognome" aria-label="Cognome" name="cognome" id="cognome" maxlength=50>
					</div>			
				</div>
				...
				<div class="col-md-6">
					<div class="input-group mb-3">
					  ...
					  <input type="text" class="form-control" placeholder="Nome" aria-label="nome" name="nome" id="nome" maxlength=50>
					</div>			
				</div>
			...
			<div class="row mb-3 mt-5">
				<div class="col-md-4">
					<button type="submit" class="btn btn-success" onclick='check_save()'>Crea/Modifica Ditta</button>
