			...
			<h4>
				...
				<div class="row">
					...
					<div class="col-md-4">
						<div class="input-group mb-3">
						  <div class="input-group-prepend">
							<span class="input-group-text" id="basic-addon2">Importo</span>
						  </div>
						  <input type="text" class="form-control" placeholder="Importo" aria-label="Importo" name="importo" id="importo" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1').replace(/^0[^.]/, '0');" required>
						</div>			
					</div>					
					<div class="col-md-4">
