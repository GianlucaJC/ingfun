<div id='div_definition' style='display:none'>
	<form method='post' action="{{ route('badge') }}" id='frm_badge1' name='frm_badge1' autocomplete="off">	
		...
		<div class="container-fluid">
			<hr>
			<h4>
				<font color='red'>Definizione Badge</font>
			</h4>
				<div class="row">
					<div class="col-md-6">
					...
					<div class="col-md-6">
						<button type="submit" class="btn btn-success" >Crea/Modifica Badge</button>
