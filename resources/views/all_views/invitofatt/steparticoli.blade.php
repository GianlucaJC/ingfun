	...
	<div class='mt-3' id='div_btn_articoli'>
		...
		!-->	
			...
			@if ($genera_pdf!="genera")
				<button type="button"  name='send_fatt' id='send_fatt' class="btn btn-outline-success btn-lg" disabled value='invia'>Invia Fattura</button>
			@else
				<button type="button" onclick="prepare_to_send({{$id_doc}})" name='send_fatt' id='send_fatt' class="btn btn-success btn-lg" value='invia'>Invia Fattura</button>
			@endif
