			...
			<div class="row mb-3">
				<div class="col-md-2">
					<div class="form-floating">
						...
						<label for="ordine">Ordinamento</label>
					</div>
				</div>
				...
				<!-- div a comparsa a seconda della scelta !-->
				<div class="col-md-3 tipoins" id='div_service'>
				  <div class="form-floating mb-3 mb-md-0">
					
					<select class="form-select" id="service" aria-label="Servizi" name='service' onchange='set_service(this.value)'>
					
						<option value=''>Select...</option>
						@foreach ($all_s as $servizio) 
							<?php
							$aliquota_v="0";
				...
				<!-- div a comparsa a seconda della scelta !-->
				<div class="col-md-3 tipoins" id='div_product'>
					<div class="form-floating">
				...
				<div class="col-md-2">
					<div class="form-floating mb-3 mb-md-0">
						...
						<label for="mag_sca">Magazzino di scarico</label>
					</div>
				</div>
