...
@section('content_main')
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">ELENCO FORNITORI</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Elenco Fornitori</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <div class="content">
      <div class="container-fluid">
		...
		<form method='post' action="{{ route('elenco_fornitori') }}" id='frm_fornitore' name='frm_fornitore' autocomplete="off">
			    ...
			    <div class="col-lg-12">
					<a href="{{ route('scheda_fornitore') }}">
						<button type="button" class="btn btn-primary">
							<i class="fa fa-plus-circle"></i> Nuovo Fornitore
						</button>
					</a>

					<div class="form-check form-switch mt-3 ml-3">
					  <input class="form-check-input" type="checkbox" id="view_dele" name="view_dele" onchange="$('#frm_fornitore').submit()" {{ $check }}>
 ...
 @section('content_plugin')
	...
	<script src="{{ URL::asset('/') }}dist/js/elenco_fornitori.js?ver=1.01"></script>
