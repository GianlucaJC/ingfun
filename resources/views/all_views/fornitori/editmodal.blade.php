      ...
      <div class="modal-body" id='body_modal'>
		<div class="row mb-3">
			...
			<div class="row mb-3">
				...
				<div class="col-md-4">
					<div class="form-floating">
						<input class="form-control" id="descrizione_prodotto" name='descrizione_prodotto' type="text" placeholder="Descrizione"  />
						<label for="descrizione_prodotto">Descrizione</label>
					</div>		
				</div>
